...
; Memory configuration: CCP at 0xE000, BDOS at 0xE800, BIOS at 0xF600

MEM:    equ     63              ; 63K system - places CCP at 0xE000

; BIOS entry points at 0xF600
BIOS:   equ     0xF600
BOOT:   equ     BIOS + 0        ; Cold start
WBOOT:  equ     BIOS + 3        ; Warm start
CONST:  equ     BIOS + 6        ; Console status
CONIN:  equ     BIOS + 9        ; Console input
CONOUT: equ     BIOS + 12       ; Console output
LIST:   equ     BIOS + 15       ; List output
PUNCH:  equ     BIOS + 18       ; Punch output
READER: equ     BIOS + 21       ; Reader input
HOME:   equ     BIOS + 24       ; Home disk
SELDSK: equ     BIOS + 27       ; Select disk
SETTRK: equ     BIOS + 30       ; Set track
SETSEC: equ     BIOS + 33       ; Set sector
SETDMA: equ     BIOS + 36       ; Set DMA address
READ:   equ     BIOS + 39       ; Read sector
WRITE:  equ     BIOS + 42       ; Write sector
PRSTAT: equ     BIOS + 45       ; List status
